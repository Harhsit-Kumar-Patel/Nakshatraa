...
const About = () => {
  return (
    <section className="py-14 md:py-18 bg-[#FAF8F5] relative z-10 border-b border-[#A6823C]/10">
      ...
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-gradient-to-br from-[#8B7BB3]/10 to-[#F4EFE6]/20 rounded-full blur-[110px] pointer-events-none animate-pulse-glow" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 text-left space-y-8 lg:pt-8">
            <InView variants={textVariants} transition={{ duration: 0.8, ease: 'easeOut' }}>
              <p className="font-body text-base md:text-lg text-[#4F5651] leading-relaxed font-light">
            ...
            <InView variants={textVariants} transition={{ duration: 0.8, ease: 'easeOut', delay: 0.2 }}>
              <div className="border-t border-b border-[#A6823C]/10 py-8 my-12">
                <p className="font-heading text-xl md:text-2xl text-[#A6823C] italic leading-relaxed font-light">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-4">
              <InView variants={textVariants} transition={{ duration: 0.8, ease: 'easeOut', delay: 0.3 }}>
                <div>
                  <h4 className="font-heading text-lg font-light text-[#0F1110] mb-2">Absolute Privacy</h4>
                  <p className="font-body text-xs text-[#4F5651] leading-relaxed font-light">
              ...
              <InView variants={textVariants} transition={{ duration: 0.8, ease: 'easeOut', delay: 0.4 }}>
                <div>
                  <h4 className="font-heading text-lg font-light text-[#0F1110] mb-2">Empathetic Approach</h4>
                  <p className="font-body text-xs text-[#4F5651] leading-relaxed font-light">
